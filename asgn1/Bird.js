...
class Bird {
    ...
    render() {
        ...
        // tail
        applyColor(darkPink);
        drawBirdTriangleFan([4.25, 2.25, 4.25, 0.25, 3.5, 0.25, 2.75, 0.75, 2.25, 1.25]);
        applyColor(lightPink);
        ...
        applyColor(lightPink);
        drawBirdTriangleFan([6.25, 7.25, 9.25, 13, 9.5, 11.25, 8.75, 9.75, 7.9, 8.25, 6.75, 6]);
